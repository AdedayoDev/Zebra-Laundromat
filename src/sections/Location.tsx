          ...
          <div className='mt-10 space-y-4'>
            {infoCards.map((card, index) => (
              <motion.article
                ...
                whileHover={{ y: -4 }}
                className='flex gap-4 rounded-4xl border border-slate-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(15,23,42,0.12)]'
              >
                <div className='flex h-14 w-14 items-center justify-center rounded-xl border border-[#002590] text-3xl text-white shadow-[0_12px_30px_rgba(0,37,144,0.16)]'>
                  <img src={card.emoji} alt={card.title} className='h-8 w-8' />
                </div>
